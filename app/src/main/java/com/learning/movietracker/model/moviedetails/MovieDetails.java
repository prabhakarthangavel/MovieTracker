...
public class MovieDetails extends BaseObservable {
    ...
    public static void bannerLoadImage(ImageView movieBanner, String bannerImageUrl){
        String imagePath = "https://image.tmdb.org/t/p/w500/"+bannerImageUrl;

        Glide.with(movieBanner.getContext())
                .load(imagePath)
                .into(movieBanner);
    }
    ...
    public void setmovieImagePath(String movieImagePath) {
        ...
        notifyPropertyChanged(BR.movieImagePath);
    }
